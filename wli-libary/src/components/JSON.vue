  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p>
        ...
        <li v-for="it in bookstores?.company || []" :key="it">
          {{ it }}
        </li>
      </p>
      ...
      <ul>
        <li v-for="type in bookstores?.storeTypes || []" :key="type.name">
      ...
      <p>We operate in: {{ bookstores?.topSellers?.join(', ') || 'unknown' }}</p>
      <p>Our #1 seller: {{ bookstores?.topSellers?.[0] || 'unknown' }}</p>
    </section>
